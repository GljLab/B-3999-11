...
export const userApi = {
  ...
  getLikedPosts: (id, params) => api.get(`/users/${id}/liked-posts`, { params }),
  getBookmarkedPosts: (id, params) => api.get(`/users/${id}/bookmarked-posts`, { params }),
  getUserComments: (id, params) => api.get(`/users/${id}/comments`, { params }),
